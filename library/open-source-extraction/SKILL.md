...
title: Open Source Extraction
version: 1.0.0
description: Extract specific packages from large open-source monorepos and adapt them for standalone use. Covers dependency
  mapping, stripping cloud/infra deps, creating shim packages, and iterative build fixing.
