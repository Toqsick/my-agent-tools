...
- aqua
related_skills:
- cyber-securing-container-registry-with-harbor
- cyber-performing-authenticated-scan-with-openvas
- cyber-conducting-network-penetration-test
- cyber-implementing-ot-network-traffic-analysis-with-nozomi
- cyber-building-vulnerability-dashboard-with-defectdojo
