---
name: cyber-detecting-network-scanning-with-ids-signatures
...
- port
related_skills:
- cyber-detecting-port-scanning-with-fail2ban
- connection-snapshot-analysis
- cyber-analyzing-cobaltstrike-malleable-c2-profiles
- cyber-hunting-for-cobalt-strike-beacons
- cyber-scanning-network-with-nmap-advanced
