...
description: "Use when user asks for PR review, diff inspection, inline review comments via gh CLI or GitHub REST. NOT for code authorship, commit authoring, or non-GitHub reviews. Review PRs: diffs, inline comments via gh or REST."
version: 1.1.0
author: Hermes Agent
license: MIT
platforms:
...
trigger_keywords: ['review', 'inline', 'comments', 'github', 'rest']
keywords: ['review', 'inline', 'comments', 'github', 'rest']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['github-issues', 'requesting-code-review', 'github-pr-workflow']
---
