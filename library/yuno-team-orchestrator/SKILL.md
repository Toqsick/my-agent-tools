...
description: |
  Use when routing a multi-domain goal across Yuno's seven specialized agents, assigning clear ownership, or consolidating their verified deliverables.
  NOT for single-specialist tasks, duplicate parallel work, or accepting agent status reports without checking artifacts and outcome evidence.
  Defines team roles, dispatch rules, coordination boundaries, and synthesis gates for the seven-agent Yuno operating model.
version: 2.1.0
author: Yuno (Hermes)
license: MIT
platforms:
...
- skill bündel
trigger_keywords: ['yuno', 'seven', 'agent', 'routing', 'multi']
keywords: ['yuno', 'seven', 'agent', 'routing', 'multi']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['yuno-team-routing', 'nous-multi-lane-routing']
---
