---
name: cyber-performing-jwt-none-algorithm-attack
...
- bypass
related_skills:
- cyber-testing-for-json-web-token-vulnerabilities
- step-execution
- cyber-performing-dmarc-policy-enforcement-rollout
- cyber-testing-for-open-redirect-vulnerabilities
- cyber-conducting-internal-network-penetration-test
