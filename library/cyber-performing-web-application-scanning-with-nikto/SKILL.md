---
name: cyber-performing-web-application-scanning-with-nikto
...
- scanner
related_skills:
- cyber-performing-mobile-device-forensics-with-cellebrite
- cyber-scanning-docker-images-with-trivy
- cyber-implementing-devsecops-security-scanning
