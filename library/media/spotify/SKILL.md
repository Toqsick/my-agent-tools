...
name: spotify
description: >-
  Use when user asks for playing or pausing Spotify, searching for tracks, artists, or albums, managing queues and playlists, or transferring playback between devices. NOT for other music services or editing local audio files. Controls Spotify playback and library actions through the smallest reliable sequence of Spotify tool calls.
version: 1.0.0
author: Hermes Agent
license: MIT
platforms:
...
trigger_keywords: ['spotify', 'and', 'playback', 'playing', 'pausing']
keywords: ['spotify', 'playback', 'user', 'asks', 'playing']
