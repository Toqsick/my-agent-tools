---
name: heartmula
description: "Use when user asks for HeartMuLa song generation, lyrics+tags music model, Suno-like local music generation. NOT for commercial music production or non-music generation tasks. HeartMuLa: Suno-like song generation from lyrics + tags."
version: 1.0.0
platforms:
- linux
- macos
...
trigger_keywords: ['generation', 'music', 'heartmula', 'song', 'lyrics']
keywords: ['generation', 'music', 'heartmula', 'song', 'lyrics']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['songwriting-and-ai-music', 'audiocraft-audio-generation', 'comfyui']
---
