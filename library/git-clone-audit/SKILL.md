...
description: "Use when user asks for systematic comparison of two local git clones, drift analysis, master-of-truth identification between clones. NOT for single-repo audit or non-git VCS comparison. Systematic comparison of two local clones of the same git repo."
triggers:
...
trigger_keywords: ['comparison', 'clones', 'systematic', 'local', 'repo']
keywords: ['comparison', 'clones', 'systematic', 'local', 'repo']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['sqlite-forensic-diff']
---
...
- `yuno-user-preferences` — Bastis Working-Style: Whitelist-Prinzip, keine Blind-Aktionen, sichere Reihenfolge
