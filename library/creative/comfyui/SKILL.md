...
name: comfyui
description: "Use when user asks for comfyui, ComfyUI workflow, image generation, video generation. NOT for text-only tasks, code generation. Generates images, video, and audio via ComfyUI with local GPU/VRAM detection."
version: 5.1.0
author:
- kshitijk4poor
- alt-glitch
...
metadata:
  hermes:
    ...
    - image_gen
    category: creative
trigger_keywords: ['comfyui', 'generation', 'video', 'workflow', 'image']
keywords: ['comfyui', 'generation', 'video', 'user', 'asks']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['video-prompting', 'beat-sync-editor', 'ascii-video']
---
