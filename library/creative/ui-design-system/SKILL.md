...
description: "Use when user asks for a full design system, design tokens, typography scales, spacing scales, complete UI system. NOT for single page mockups or one-off style exploration. Generate a complete design system (tokens, colors, typography)."
version: 1.0.0
changelog:
...
metadata:
  hermes:
    ...
    domain: multimedia
    converted_at: 2026-07-03 23:19:32.978737
  tags:
  - hub
  - conversion
  - workflow
...
routing_hint: '**Agent-Scope:** UI/UX, visual, art-styles, design-systems, motion.
  ...
  '
trigger_keywords: ['design', 'system', 'tokens', 'typography', 'scales']
keywords: ['design', 'system', 'tokens', 'typography', 'scales']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['design-md', 'ui-color-system', 'sketch']
---
