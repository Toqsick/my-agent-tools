...
name: audiobook
description: |
  Use when turning source text into an audiobook, splitting chapters, assigning narrator or character voices, synthesizing TTS, or packaging EPUB-linked audio.
  NOT for a single short voice clip, voice cloning from a reference sample, or video production without an audiobook workflow.
  Provides a resumable production pipeline for chapter preparation, voice mapping, TTS generation, quality control, and final audiobook assembly.
version: 0.3.11
changelog:
...
- voice acting
- 有声书
trigger_keywords: ['audiobook', 'voice', 'production', 'turning', 'source']
keywords: ['audiobook', 'voice', 'production', 'turning', 'source']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['voice-assistant-bots', 'humanizer']
---
