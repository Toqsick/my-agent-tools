...
name: image-remix
description: |
  Use when the user shares a reference image (style, character, layout) and asks for new images in that visual style — image-remix, visual continuation, style transfer, or variant generation.
  NOT for creating original art without a reference, image editing/photoshop work, or non-image creative deliverables (use other creative skills).
  Image-remix workflow: take a shared reference image and generate new variants that preserve its style, subject, or composition.
version: 0.7.9
changelog:
...
triggers:
- image-remix
trigger_keywords: ['image', 'style', 'reference', 'visual', 'remix']
keywords: ['image', 'style', 'reference', 'visual', 'remix']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['anime-style-forge', 'anime-design']
---
