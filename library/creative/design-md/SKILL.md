...
name: design-md
description: Use when user asks for design md, DESIGN.md Skill, When to use this skill, File anatomy. NOT for building interfaces, implementation. Authors and validates Google DESIGN.md design token specification files.
version: 1.0.0
author: Hermes Agent
license: MIT
platforms:
...
trigger_keywords: ['design', 'skill', 'design-md', 'this', 'file']
keywords: ['design', 'skill', 'user', 'asks', 'file']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['claude-design', 'popular-web-designs', 'anime-design']
---
