...
description: Use when user asks for ideation, Creative Ideation, When to use, How It Works. NOT for unrelated tasks, simple questions. Provides ideation capability.
version: 1.0.0
author: SHL0MS
license: MIT
platforms:
...
agent: "Yuno"
routing_hint: "Brainstorming-/Intent-Klärungs-Phase vor jedem Build. Cross-domain, fast jedes Projekt startet hier. Pair mit plan-mode für Voraussetzungs-Klärung."
trigger_keywords: ['ideation', 'creative', 'how', 'works', 'not']
keywords: ['ideation', 'user', 'asks', 'creative', 'works']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['creative-suite']
---
