...
name: pretext
description: |
  Use when building a creative browser demo with the pretext typography library, generating kinetic typography, animating text layouts on a canvas, or composing a pretext-driven interactive page.
  NOT for static docs work, plain CSS typography, or non-canvas text rendering — use p5js / claude-design / excalidraw for those.
  Build creative browser demos and kinetic-typography pieces with the pretext library.
version: 1.0.0
author: Hermes Agent
license: MIT
platforms:
...
trigger_keywords: ['typography', 'pretext', 'creative', 'browser', 'library']
keywords: ['typography', 'pretext', 'creative', 'browser', 'library']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['ui-design-system', 'browser-setup-guides']
---
