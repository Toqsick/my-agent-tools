...
description: |
  Use when you need to use the pitfalls workflow and its documented procedures.
  NOT for unrelated tasks outside the pitfalls workflow.
  Provides focused guidance for pitfalls.
version: 1.0.0
changelog:
...
metadata:
  hermes:
    source: minimax-hub
    hub_skill_id: orchestration-multi-agent-pitfalls-cheatsheet
    category: pitfalls
    domain: orchestration
    converted_at: '2026-07-03T23:19:32.983959'
  tags:
  - hub
  - conversion
  - workflow
...
> **Hub Origin:** Convexed from MiniMax Hub skill `orchestration/multi-agent-pitfalls-cheatsheet` (version 1.0.0). Original Hub-SKILL.md is preserved at `scripts-originals/SKILL.md.hub`, original meta.yaml at `scripts-originals/meta.yaml.hub`. All Hub-specific paths (e.g. `~/.hub-global/skills/orchestration-multi-agent-pitfalls-cheatsheet/`) translated to Hermes-equivalent references in `references/`.
