...
description: Orchestrate parallel AI agent workstreams — multi-agent deep research (3 parallel experts), research orchestration
  (improvement plans), and subagent-driven development. Covers scope splitting, expert briefing, synthesis, and retrospective
  patterns.
version: 1.0.0
