---
name: cyber-implementing-gcp-vpc-firewall-rules
...
- network
related_skills:
- cyber-configuring-pfsense-firewall-rules
- cyber-implementing-microsegmentation-with-guardicore
- cyber-implementing-beyondcorp-zero-trust-access-model
- cyber-performing-packet-injection-attack
- cyber-implementing-network-segmentation-with-firewall-zones
