...
trigger_keywords: ['cleanup', 'report', 'the', 'safety', 'yuno-cleaner']
keywords: ['cleanup', 'report', 'safety', 'user', 'asks']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['greyhack-computer-use-suite']
---
...
```
0 3 * * 0 TELEGRAM_BOT_TOKEN=*** TELEGRAM_CHAT_ID=7222661188 \
