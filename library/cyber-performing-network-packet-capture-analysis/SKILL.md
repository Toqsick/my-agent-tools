---
name: cyber-performing-network-packet-capture-analysis
...
- packet
related_skills:
- cyber-performing-sqlite-database-forensics
- cyber-analyzing-disk-image-with-autopsy
- cyber-performing-windows-artifact-analysis-with-eric-zimmerman-tools
- cyber-implementing-network-traffic-analysis-with-arkime
- cyber-performing-cloud-storage-forensic-acquisition
