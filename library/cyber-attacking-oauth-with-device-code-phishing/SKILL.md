...
version: '1.0'
description: Run OAuth 2.0 device-code and illicit-consent phishing against Microsoft Entra ID to steal access and refresh
  tokens, bypass MFA, and pivot across Microsoft 365 services.
...
- microsoft
related_skills:
- cyber-implementing-mimecast-targeted-attack-protection
- cyber-detecting-suspicious-oauth-application-consent
- cyber-orchestrating-llm-attacks-with-pyrit
- cyber-detecting-oauth-token-theft
