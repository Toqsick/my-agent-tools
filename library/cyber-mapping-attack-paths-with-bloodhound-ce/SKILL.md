...
version: '1.0'
description: Collect Active Directory data with SharpHound and Entra ID data with AzureHound, ingest into BloodHound Community
  Edition, and analyze on-prem, cloud, and hybrid attack paths with built-in queries and custom Cypher.
...
- sharphound
related_skills:
- cyber-performing-active-directory-bloodhound-analysis
- web-app-seo
- cyber-exploiting-adcs-with-certipy
- cyber-exploiting-active-directory-with-bloodhound
- cyber-exploiting-constrained-delegation-abuse
