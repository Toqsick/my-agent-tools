...
title: Coercing Authentication With Coercer Petitpotam
version: '1.0'
description: Trigger machine account authentication with PetitPotam (MS-EFSR) and Coercer across MS-RPRN, MS-DFSNM, and MS-FSRVP
  to feed NTLM relay into AD CS Web Enrollment (ESC8) and other relay targets.
