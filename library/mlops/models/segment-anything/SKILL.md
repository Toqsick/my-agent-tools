...
description: >-
  Use when user asks for segmenting objects without task-specific training, building point- or box-prompt annotation tools, generating masks for training data, or running automatic image segmentation. NOT for generating new images or classifying an image without masks. Explains SAM checkpoints, predictors, flexible prompts, automatic mask generation, Transformers usage, and domain transfer.
version: 1.0.0
...
trigger_keywords: ['without', 'training', 'generating', 'masks', 'automatic']
keywords: ['without', 'training', 'generating', 'masks', 'automatic']
