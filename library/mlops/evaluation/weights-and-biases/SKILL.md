...
description: >-
  Use when user asks for logging machine-learning experiments, comparing training runs in dashboards, running hyperparameter sweeps, versioning models or datasets as artifacts, or managing a model registry. NOT for serving inference endpoints or simple local logs that must stay offline. Integrates W&B run tracking, configurations, metrics, artifacts, sweeps, collaboration, and model lineage into training workflows.
version: 1.0.0
...
trigger_keywords: ['training', 'sweeps', 'artifacts', 'model', 'user']
keywords: ['training', 'sweeps', 'artifacts', 'model', 'user']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['serving-llms-vllm', 'axolotl']
---
---
