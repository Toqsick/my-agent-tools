...
description: >-
  Use when user asks for deploying a high-throughput LLM API, serving an OpenAI-compatible endpoint, configuring tensor parallelism or quantization, or running offline batched inference. NOT for CPU or edge inference or training or fine-tuning models. Provides production vLLM patterns for GPU memory management, concurrency, caching, metrics, Docker, load tests, and batching.
version: 1.0.0
...
trigger_keywords: ['inference', 'serving-llms-vllm', 'deploying', 'high-throughput', 'llm']
keywords: ['inference', 'user', 'asks', 'deploying', 'high']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['weights-and-biases', 'ollama-local-hosting']
---
---
