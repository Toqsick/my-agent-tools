...
name: llama-cpp
description: >-
  Use when user asks for running a GGUF model locally, finding GGUF files on Hugging Face, choosing a quantization for available RAM or VRAM, or starting a llama.cpp OpenAI-compatible server. NOT for fine-tuning model weights or high-throughput multi-user GPU serving. Covers model discovery, quant selection, llama-cli and llama-server commands, Python bindings, chat, streaming, and embeddings.
version: 2.1.2
...
trigger_keywords: ['model', 'llama', 'user', 'gguf', 'server']
keywords: ['model', 'llama', 'user', 'gguf', 'server']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['deep-model-evaluation', 'local-ml-hosting', 'ollama-local-hosting']
---
---
