...
name: obliteratus
description: >-
  Use when user asks for removing refusal behavior from an open-weight LLM, abliterating or uncensoring a local model, analyzing refusal directions, or choosing an OBLITERATUS method and parameters. NOT for jailbreaking a hosted API or ordinary supervised fine-tuning. Guides hardware checks, method selection, direction extraction, telemetry-based recommendations, execution, and model validation.
version: 2.0.0
author: Hermes Agent
license: MIT
dependencies:
...
trigger_keywords: ['obliteratus', 'refusal', 'model', 'method', 'and']
keywords: ['refusal', 'model', 'method', 'user', 'asks']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['local-ml-hosting']
---
---
