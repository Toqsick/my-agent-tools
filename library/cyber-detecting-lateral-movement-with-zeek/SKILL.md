---
name: cyber-detecting-lateral-movement-with-zeek
title: Detecting Lateral Movement With Zeek
version: '1.0'
...
- traffic
related_skills:
- cyber-analyzing-network-traffic-for-incidents
- cyber-detecting-lateral-movement-with-splunk
- cyber-implementing-canary-tokens-for-network-intrusion
- cyber-implementing-siem-correlation-rules-for-apt
- cyber-analyzing-network-traffic-of-malware
