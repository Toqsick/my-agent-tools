...
- controls
related_skills:
- cyber-implementing-api-gateway-security-controls
- cyber-performing-api-rate-limiting-bypass
- cyber-securing-api-gateway-with-aws-waf
- cyber-performing-bandwidth-throttling-attack-simulation
- cyber-implementing-ddos-mitigation-with-cloudflare
