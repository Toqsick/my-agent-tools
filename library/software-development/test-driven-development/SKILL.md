...
description: |
  Use when you enforce a TDD discipline — RED-GREEN-REFACTOR cycle, tests written before production code, regression coverage, and a clear pass/fail signal — on any new feature or bug-fix.
  NOT for throwaway prototypes, legacy code without test infrastructure, exploratory spike scripts, or one-shot shell-oneliners.
  TDD discipline toolkit: RED-GREEN-REFACTOR cycle, test-first workflow, regression coverage, executable specs as living documentation.
version: 1.1.0
...
trigger_keywords: ['discipline', 'green', 'refactor', 'cycle', 'code']
keywords: ['discipline', 'green', 'refactor', 'cycle', 'code']
