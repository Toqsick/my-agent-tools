...
name: python-debugpy
description: |
  Use when breakpoints, pdb inspection, post-mortem debugging, subprocess attachment, or remote debugpy DAP sessions are needed to diagnose Python behavior.
  NOT for issues that logging, print statements, static analysis, or ordinary pytest tracebacks can resolve quickly.
  Offers focused recipes for local and remote Python debugging, variable inspection and mutation, attach workflows, and common debugger pitfalls.
version: 1.0.0
author: Hermes Agent
license: MIT
platforms:
...
trigger_keywords: ['inspection', 'debugging', 'remote', 'python', 'breakpoints']
keywords: ['inspection', 'debugging', 'remote', 'python', 'breakpoints']
