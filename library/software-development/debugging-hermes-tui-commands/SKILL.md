...
description: |
  Use when you need to use the debugging-hermes-tui-commands workflow and its documented procedures.
  NOT for unrelated tasks outside the debugging-hermes-tui-commands workflow.
  Provides focused guidance for debugging-hermes-tui-commands.
version: 1.0.0
author: Hermes Agent
license: MIT
platforms:
...
trigger_keywords: ['debugging', 'hermes', 'commands', 'workflow', 'need']
keywords: ['debugging', 'hermes', 'commands', 'workflow', 'need']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['voice-clone', 'hermes-admin', 'github-workflow']
---
