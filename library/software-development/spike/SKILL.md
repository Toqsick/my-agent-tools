...
name: spike
description: |
  Use when testing technical feasibility, comparing approaches, building a disposable prototype, or surfacing unknowns before committing to a production implementation.
  NOT for production-ready delivery, open-ended documentation research, or persistent GSD spike management when the dedicated gsd-spike skill is available.
  Runs risk-first, time-boxed experiments with observable criteria, captured evidence, and a clear keep, change, or abandon verdict.
version: 1.0.0
...
trigger_keywords: ['production', 'spike', 'testing', 'technical', 'feasibility']
keywords: ['production', 'spike', 'testing', 'technical', 'feasibility']
