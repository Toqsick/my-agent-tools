---
name: cyber-detecting-entra-offensive-tools-in-graph-logs
title: Detecting Entra Offensive Tools In Graph Logs
version: '1.0'
description: Hunt AADGraphActivityLogs and MicrosoftGraphActivityLogs in Microsoft Sentinel/Log Analytics for fingerprints
  of offensive Entra ID tools such as ROADtools, AADInternals, and AzureHound.
...
- fingerprints
related_skills:
- cyber-building-cloud-siem-with-sentinel
- cyber-implementing-siem-use-cases-for-detection
