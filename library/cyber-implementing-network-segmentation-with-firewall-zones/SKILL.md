---
name: cyber-implementing-network-segmentation-with-firewall-zones
...
- network
related_skills:
- cyber-implementing-purdue-model-network-segmentation
- cyber-building-devsecops-pipeline-with-gitlab-ci
- cyber-implementing-conduit-security-for-ot-remote-access
- cyber-implementing-zero-trust-network-access-with-zscaler
- cyber-implementing-privileged-access-workstation
