...
metadata:
  hermes:
    ...
    related_skills: []
license: MIT
trigger_keywords: ['author', 'hermes', 'color', 'theme', 'skins']
keywords: ['author', 'hermes', 'color', 'theme', 'skins']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['obsidian-vault-color-consolidation', 'ui-color-system', 'tui-widgets']
---
