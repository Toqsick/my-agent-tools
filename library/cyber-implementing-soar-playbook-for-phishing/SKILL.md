---
name: cyber-implementing-soar-playbook-for-phishing
...
- using
related_skills:
- cyber-detecting-aws-guardduty-findings-automation
- cyber-implementing-soar-automation-with-phantom
- cyber-implementing-velociraptor-for-ir-collection
- cyber-analyzing-network-traffic-with-wireshark
- cyber-performing-red-team-phishing-with-gophish
