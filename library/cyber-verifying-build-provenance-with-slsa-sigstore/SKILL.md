...
title: Verifying Build Provenance With Slsa Sigstore
version: '1.0'
description: Verify signed artifacts and SLSA build provenance with Sigstore cosign and slsa-verifier, enforce keyless OIDC
  identity, and apply SLSA Build levels to harden the software supply chain.
