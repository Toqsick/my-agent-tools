...
name: linear
description: >-
  Use when user asks for listing or searching Linear issues, creating or updating Linear issues, managing projects, teams, states, labels, or assignees, or querying Linear through GraphQL. NOT for GitHub issue management or editing a generic local task list. Provides GraphQL and helper-script patterns for Linear identity, workflows, pagination, mutations, relationships, and project operations.
version: 1.0.0
author: Hermes Agent
license: MIT
platforms:
...
trigger_keywords: ['linear', 'issues', 'graphql', 'and', 'listing']
keywords: ['linear', 'issues', 'graphql', 'user', 'asks']
