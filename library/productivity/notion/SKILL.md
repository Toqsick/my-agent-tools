...
name: notion
description: >-
  Use when user asks for searching Notion pages, reading or creating pages as Markdown, querying or mutating Notion databases, using the ntn CLI or Notion API, or managing Notion workers. NOT for Obsidian filesystem notes or general website content management. Provides authenticated CLI and REST paths for pages, blocks, databases, Markdown conversion, pagination, and structured mutations.
version: 2.0.0
author: community
license: MIT
platforms:
...
trigger_keywords: ['notion', 'pages', 'markdown', 'databases', 'user']
keywords: ['notion', 'pages', 'markdown', 'databases', 'user']
