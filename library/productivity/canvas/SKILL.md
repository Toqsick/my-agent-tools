...
name: canvas
description: >-
  Use when user asks for listing Canvas LMS courses, fetching course assignments, sorting assignments by due date, or troubleshooting Canvas API access. NOT for HTML canvas graphics or submitting coursework or changing grades. Uses Canvas scripts and REST endpoints to retrieve enrolled-course and assignment data with clear setup, output, and troubleshooting rules.
version: 1.0.0
author: community
license: MIT
platforms:
...
metadata:
  hermes:
    ...
    - Courses
    - Assignments
trigger_keywords: ['canvas', 'course', 'assignments', 'troubleshooting', 'user']
keywords: ['canvas', 'course', 'assignments', 'troubleshooting', 'user']
