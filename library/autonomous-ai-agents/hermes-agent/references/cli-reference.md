...
Full command-line interface reference for Hermes Agent.
...
(`hermes mcp install <name>`): see `native-mcp.md` in this directory.
...
patterns: see `webhooks.md` in this directory.
...
hermes memory setup/status  Honcho memory integration (via plugins/memory/honcho/)
