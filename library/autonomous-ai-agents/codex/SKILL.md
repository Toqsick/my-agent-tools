...
name: codex
description: Use when user asks for codex, Codex CLI, When to use, Prerequisites. NOT for writing docs, design only. Delegates coding to OpenAI Codex CLI with one-shot and background modes.
version: 1.0.0
author: Hermes Agent
license: MIT
platforms:
...
trigger_keywords: ['codex', 'cli', 'prerequisites', 'not', 'writing']
keywords: ['codex', 'user', 'asks', 'prerequisites', 'writing']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['kanban-codex-lane', 'blackbox', 'opencode']
---
