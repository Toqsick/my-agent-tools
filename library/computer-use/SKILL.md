...
name: computer-use
description: Use when user asks for computer use, Computer Use (universal, any-model, cross-platform), The canonical workflow, Capture modes. NOT for file management, email. Drives desktop automation across macOS, Windows, and Linux via cua-driver.
version: 2.0.0
platforms:
- macos
- windows
...
author: Hermes Agent
license: MIT
trigger_keywords: ['computer', 'computer-use', 'universal', 'any-model', 'cross-platform']
keywords: ['computer', 'user', 'asks', 'universal', 'model']
last_curated: '2026-07-23'
curated_by: 'Yuno'
related_skills: ['computer-use-game-reconnaissance']
---
