...
version: '1.0'
description: Find over-permissive RBAC roles and service-account token abuse paths in Kubernetes using kubectl auth can-i,
  rbac-police, kubectl-who-can, and rakkess during authorized cluster security reviews.
...
- roles
related_skills:
- cyber-auditing-kubernetes-cluster-rbac
- cyber-performing-aws-privilege-escalation-assessment
