---
name: cyber-implementing-purdue-model-network-segmentation
...
- purdue
related_skills:
- cyber-implementing-container-network-policies-with-calico
- cyber-implementing-kubernetes-network-policy-with-calico
- cyber-implementing-api-security-posture-management
- cyber-implementing-microsegmentation-with-guardicore
- cyber-implementing-zero-trust-network-access-with-zscaler
