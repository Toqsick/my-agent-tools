...
title: Abusing Shadow Credentials For Privesc
version: '1.0'
description: Take over Active Directory user and computer accounts by writing alternate certificate keys to msDS-KeyCredentialLink
  (Shadow Credentials) with pyWhisker, Whisker, and Certipy, then authenticate via PKINIT.
...
- user
related_skills:
- cyber-exploiting-nopac-cve-2021-42278-42287
- notebooklm-bridge
- claude-coder
- claude-coding-specialist
- petdex
